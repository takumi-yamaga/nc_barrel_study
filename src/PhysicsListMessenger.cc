...
{   
  fPListCmd = new G4UIcmdWithAString("/exx_acceptance_study/Physics",this);
  ...
  fListCmd = new G4UIcmdWithoutParameter("/exx_acceptance_study/ListPhysics",this);
...
void PhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  if( command == fPListCmd ) {
    if(fPhysicsList) {
      ...
      G4cout << "### PhysicsListMessenger WARNING: "
             << " /exx_acceptance_study/Physics UI command is not available "
    ...
    if(fPhysicsList) {
      ...
      G4cout << "### PhysicsListMessenger WARNING: "
             << " /exx_acceptance_study/ListPhysics UI command is not available "
             << "for reference Physics List" << G4endl;
    }
  }
}
